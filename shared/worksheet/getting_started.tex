...
Look at the small screen on the robot. It should look like picture 1 below. 
...
What did the robot say? It should have said ``Hello World!". This is a simple program to get youstarted. If the robot didn't speak or make any noise, ask your session leader for help.
