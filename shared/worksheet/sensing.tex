...
\begin{enumerate}
    \item Put the robot on the piece of paper on your desk, with the wheels on the start line.
...
\begin{enumerate}
    \setcounter{enumi}{6} 
    \item Find the lines in the program that define \code{LINE_REF} and \code{stop_reflectance}, then read the comments to see what they are used for.
    \item Change the program's reflectance value for the line to make the robot stop at the grey line.
    \item Download your new program to the robot and run it to test whether your robot stops on the grey line.
\end{enumerate}
