...
\newcommand{\sessionversion}{\ifcsname SESSION_NAME\endcsname\SESSION_NAME\else \texttt{<session\_name>}\fi \ifcsname SESSION_VERSION\endcsname\SESSION_VERSION\else v?.?\fi}
